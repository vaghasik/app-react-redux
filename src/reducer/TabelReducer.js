export default function TabelReducer(state = "", action) {
  switch (action.type) {
    case "GET_TABLE_DATA":
      //console.log('dataTest', action.appsList);
      return {
        ...state,
    ...
    case "GET_SUB_MENU_TABLE_DATA":
      return {
        ...state,
        serviceName: action.serviceName ? action.serviceName : '',
        sQueryLink: action.sQueryLink ? action.sQueryLink : "",
        dataList: action.dataList ? action.dataList : "",
        TabList: action.TabList ? action.TabList : "",
        selectedTab: action.selectedTab ? action.selectedTab : "",
      }
    case "GET_ENTITY_TABLE_DATA":
      return {
        ...state,
